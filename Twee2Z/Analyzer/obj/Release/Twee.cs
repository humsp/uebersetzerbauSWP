...
public partial class Twee : Parser {
	public const int
		PRINT=37, FORMAT=6, ENDNOBR=30, LINK_START=4, STRING_START2=10, PIPE=45, 
		FUNC_BRACKET_CLOSE=24, LINK_END=49, ELSE_IF=26, STRING_BODY=19, ELSE=27, 
		IF=25, WORD=12, STRING_BODY2=21, VAR_NAME=5, ENDSILENTLY=32, SQ_BRACKET_OPEN=47, 
		NEW_LINE=8, PASS=2, MACRO_START=3, MACRO_BRACKET_OPEN=38, TEST=42, EXCLUDE=7, 
		STRING_END=20, SET=36, PMODE_END=18, FUNC_LINK=44, STRING_END2=22, INT=1, 
		SPACE=11, CHOICE=34, DISPLAY=35, PMODEWORD=14, ACTIONS=33, TAG_BEGIN=16, 
		MACRO_END=39, EXP_END_M=43, WORDS=48, ENDIF=28, SILENTLY=31, STRING_START=9, 
		NOBR=29, SQ_BRACKET_CLOSE=46, STRING=13, EXPRESSION_BODY=41, TAG=15, FUNC_BRACKET_OPEN=23, 
		TAG_END=17, EXPRESSION=40, EXP_END_L=50, FUNC_START=51, FUNC_PARAM=52, 
		EXP_END=53;
	public const int
